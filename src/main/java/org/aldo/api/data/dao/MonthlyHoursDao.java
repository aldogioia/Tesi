...
public interface MonthlyHoursDao extends JpaRepository<MonthlyHours, String> {
    ...
    MonthlyHours findByMonthAndYearlyHours_YearAndYearlyHours_Collaboration_Project_CupAndYearlyHours_Collaboration_Professor_Id(
            Month month, Year year, Long projectCup, Integer professorId);
}